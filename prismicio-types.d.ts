...
interface SkaterDocumentData {
  ...
  /**
   * Photo BG field in *Skater*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.photo_bg
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  photo_bg: prismic.ImageField<never>;

  /**
   * Photo FG field in *Skater*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.photo_fg
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  photo_fg: prismic.ImageField<never>;
...
export interface HeroSliceDefaultPrimary {
  /**
   * Headingg field in *Hero → Default → Primary*
   *
...
export interface TextAndImageSliceDefaultPrimary {
  ...
  /**
   * BG Img field in *TextAndImage → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.default.primary.bg_img
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  bg_img: prismic.ImageField<never>;

  /**
   * ForegroundImg field in *TextAndImage → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.default.primary.foregroundimg
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  foregroundimg: prismic.ImageField<never>;
}
...
/**
 * Primary content in *TextAndImage → IMG on Left → Primary*
 */
export interface TextAndImageSliceImgOnLeftPrimary {
  /**
   * Theme field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.theme
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  theme: prismic.SelectField<"Blue" | "Orange" | "Navy" | "Lime">;

  /**
   * Heading field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Button field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.button
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  button: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;

  /**
   * BG Img field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.bg_img
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  bg_img: prismic.ImageField<never>;

  /**
   * ForegroundImg field in *TextAndImage → IMG on Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imgOnLeft.primary.foregroundimg
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  foregroundimg: prismic.ImageField<never>;
}
...
/**
 * IMG on Left variation for TextAndImage Slice
 *
 * - **API ID**: `imgOnLeft`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TextAndImageSliceImgOnLeft = prismic.SharedSliceVariation<
  "imgOnLeft",
  Simplify<TextAndImageSliceImgOnLeftPrimary>,
  never
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextAndImageSliceImgOnLeftPrimary,
      TextAndImageSliceVariation,
      TextAndImageSliceDefault,
      TextAndImageSliceImgOnLeft,
      VideoBlockSlice,
